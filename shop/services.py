...
from django.db.models import Q, Case, When, Value, CharField, F, Prefetch, Sum
    ...
    def _generate_procurement_sheet(self):
        ...
        items = OrderItem.objects.filter(
            ...
            constructed_label=Case(
                When(attribute_name__isnull=False, then=Concat('product__title', Value(' '), 'attribute_name')),
        ...
        for supplier in suppliers:
            ...
            for item in supplier_items:
                ...
                def cell(c, v, bold=False, fill=None):
                    ...
                    cl.alignment = Alignment(wrapText=True, horizontal='center', vertical='center')
            ...
            if sum_range_end >= start_row:
                total_cell = ws2.cell(row=row_num, column=4, value=f'=SUM(E{start_row}:E{sum_range_end})')
