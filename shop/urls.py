...
urlpatterns = [
    ...
    path(
        "accept-checkout-offer",
        views.accept_checkout_offer,
        name="accept_checkout_offer",
    ),
    path(
        "get-checkout-offer-status",
        views.get_checkout_offer_status,
        name="get_checkout_offer_status",
    ),
    path("checkout/", CheckoutView, name="checkout"),
    path(
        "check-abandoned-carts",
        views.create_or_check_abandoned_cart,
        name="create_or_check_abandoned_cart",
    ),
    path(
        "remove-abandoned-cart", views.remove_abandoned_cart, name="removeabandonedcart"
    ),
    ...
    path(
        "change-offer-checkout-qty",
        views.change_offer_checkout_qty,
        name="change_offer_checkout_qty",
    ),
    ...
    path(
        "shopmanager/abandoned-carts",
        views.shopmanager_abandoned_carts,
        name="shabandonedcarts",
    ),
    ...
    path(
        "pravila-na-koristenje/",
        views.Pravila_Na_Koristenje,
        name="rights-of-usage-page",
    ),
