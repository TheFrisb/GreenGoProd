...
urlpatterns = [
    path(
        "create-already-existing-campaign-ad/",
        views.create_already_existing_campaign_ad,
        name="create_already_existing_campaign_ad",
    ),
    path("get-campaign-adsets", views.get_campaign_adsets, name="get_campaign_adsets"),
    path(
        "remove-stored-audience",
        views.remove_stored_audience,
        name="remove_stored_audience",
    ),
    ...
    path(
        "save-new-campaign-id", views.save_new_campaign_id, name="save_new_campaign_id"
    ),
    ...
    path(
        "generate-ad-video-thumbnail",
        views.generate_ad_video_thumbnail,
        name="generate_ad_video_thumbnail",
    ),
    path(
        "get-video-thumbnails", views.get_video_thumbnails, name="get_video_thumbnails"
    ),
    path(
        "upload-campaign-photo",
        views.upload_campaign_photo,
        name="upload_campaign_photo",
    ),
    path(
        "upload-campaign-video",
        views.upload_campaign_video,
        name="upload_campaign_video",
    ),
    ...
    path(
        "daily_ad_spend/<int:pk>/",
        views.daily_ad_spend_by_id,
        name="daily_ad_spend_by_id",
    ),
