...
$(document).ready(function () {
  ...
  function get_iso_date(date){
    ...
    $.ajax({
        url: 'https://korpaplus.com/analytics/get-open-audience',
        method: 'GET',
        data: {
    ...
    $(document).on('click', '.dropdown-select .option', function (event) {
        ...
        $.ajax({
            url: 'https://korpaplus.com/analytics/get-campaign-adsets',
            method: 'GET',
            data: {
    ...
    $(document).on('click', '.submit_media_photo', function(e){
        ...
        if(file == null){
            ...
            $.ajax({
                url: 'https://korpaplus.com/analytics/upload-campaign-photo',
                method: 'POST',
                data: data,
                processData: false,
                contentType: false,
    ...
    $(document).on('click', '.submit_media_video', function(e){
        ...
        if(file == null){
            ...
            data.append('csrfmiddlewaretoken', token);
            $.ajax({
                url: 'https://korpaplus.com/analytics/upload-campaign-video',
                method: 'POST',
                data: data,
                processData: false,
                contentType: false,
                success: function (data) {
                    ...
                    $.ajax({
                        url: 'https://korpaplus.com/analytics/get-video-thumbnails',
                        method: 'GET',
                        data: {
                            'ad_id': ad_id,
                            'csrfmiddlewaretoken': token
    ...
    $(document).on('click', '.search_audiences_btn', function(e){
        ...
        if(search_term == ''){
            ...
            $.ajax({
                url: 'https://korpaplus.com/analytics/search-ad-audiences',
                method: 'GET',
                data: {
    ...
    $(document).on('click', '.video_generate_thumbnail_btn', function(e){
        ...
        $.ajax({
            url: 'https://korpaplus.com/analytics/generate-ad-video-thumbnail',
            method: 'GET',
            data: {
                'ad_id': ad_id,
    ...
    $(document).on('click', '#create_campaign', function(e){
        ...
        if(validate_all_inputs()){
            ...
            $.ajax({
                url: 'https://korpaplus.com/analytics/create-campaign',
                type: 'POST',
                data: {
                    'csrfmiddlewaretoken': token,
                ...
                success: function(response){
                    ...
                    // $.ajax({
                    //     url: 'https://korpaplus.com/analytics/save-new-campaign-id',
                    //     type: 'POST',
                    //     data: {
                    //         'csrfmiddlewaretoken': token,
    ...
    $(document).on("click", ".create_ad_preview" ,function(){
        ...
        console.log('ad_prev')
        $.ajax({
            url: 'https://korpaplus.com/analytics/get-ad-previews',
            type: 'GET',
            data: {
                'csrfmiddlewaretoken': token,
                'ad_primary_text': ad_primary_text,
    ...
    $(document).on("click", "#store_new_audience_btn" ,function(){
        ...
        $.ajax({
            url: 'https://korpaplus.com/analytics/store-new-audience',
            type: 'POST',
            data: {
    ...
    $(document).on("click", ".remove_stored_audience", function(){
        ...
        $.ajax({
            url: 'https://korpaplus.com/analytics/remove-stored-audience',
            type: 'POST',
            data: {
                'csrfmiddlewaretoken': token,
