    ...
    $(document).on('click', '.video_generate_thumbnail_btn', function(e){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(button).closest('.thumbnail_bundles').append('<div class="col-md-3 my-2 thumbnail-container rounded manual_thumbnail"><img src="' + data.thumbnail_url + '" class="img-thumbnail thumbnail-option" style="cursor:pointer!important"></div>')
            }
        })
