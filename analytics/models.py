...
from shop.models import Product, OrderItem, ProductCampaigns
import datetime
...
class DailyRow(models.Model):
    owner = models.ForeignKey(DailyItems, on_delete=models.SET_NULL, null=True, verbose_name='Дневен ред на информации')
...
class FacebookAd(models.Model):
    main_image = models.ImageField(upload_to='campaigns/ads/ad_images/%Y/%m/%d/', null=True,
                                   verbose_name='Слика на реклама')
    main_video = models.FileField(upload_to='campaigns/ads/ad_videos/%Y/%m/%d/', null=True,
                                  verbose_name='Видео на реклама')
    video_thumbnail = models.ImageField(upload_to='campaigns/ads/ad_videos/thumbnails/%Y/%m/%d/', null=True,
...
class FacebookAdSet(models.Model):
    campaign_parent = models.ForeignKey(ProductCampaigns, on_delete=models.SET_NULL, null=True, verbose_name='Кампања')
