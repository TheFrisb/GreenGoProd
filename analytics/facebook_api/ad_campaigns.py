...
# def create_ad_campaign2():
#     access_token = 'EAAKTm5ZCryJABALw4plizt8ZCxYLMha8j9zqF14FI1icZCKu0vI4KPkvZBRo21UfpD2hvLv9emOqG9taiGMTmbD7y89ZAOKNZAZAwxJz7JhpZAY6I8SJqxHj4Kc7cf2zIZCDUsJ7P8wPz4omJS94ZB83lxUmCyneFrOAmWq3s2mbSSeBM3iAUxLldUp4CTPp7JbgktJ6Ljy2d1hQZDZD'
#     app_secret = 'ac0c0236c024052d441c246e516f5443'
#     app_id = '725246565664912'
#     ad_account_id = 'act_3944984375629692'
#     instagram_account_id = '5225011497548175'
...
#     if(ad_type == 'image'):
#         image_path = 'media/products/2023/03/23/test_image.jpg'
#         image = AdImage(parent_id=ad_account_id)
...
#         # Create creative
#         link_data = AdCreativeLinkData()
#         link_data[AdCreativeLinkData.Field.link] = 'https://greengoshop.mk/product/SOLAREN-ULTRAZVUCEN-RASTERUVAC-KRUG/'
#         link_data[AdCreativeLinkData.Field.message] = 'Check out our website! ❤️' #Primary text
#         link_data[AdCreativeLinkData.Field.description] = 'Check out our website desription!! ❤️' #Description
        
#         link_data[AdCreativeLinkData.Field.caption] = 'www.greengoshop.mk'
#         # set the link_data headline
#         link_data[AdCreativeLinkData.Field.name] = 'asd' #Headline

#         link_data[AdCreativeLinkData.Field.message] = 'asd' #Primary text
#         link_data[AdCreativeLinkData.Field.image_hash] = image.get_hash()
#         link_data[AdCreativeLinkData.Field.call_to_action] = {
#         'type': 'SHOP_NOW',
#         'value': {
#             'link': 'https://greengoshop.mk/product/SOLAREN-ULTRAZVUCEN-RASTERUVAC-KRUG/'
#         }
#         }
#         object_story_spec = AdCreativeObjectStorySpec()
#         object_story_spec[AdCreativeObjectStorySpec.Field.page_id] = '110068238444042'
...
#         video_path = 'media/campaigns/ads/ad_videos/2023/03/28/1.mp4'
#         thumbnail_path = 'media/campaigns/ads/ad_videos/thumbnails/2023/03/29/test.png'
#         video = AdVideo(parent_id=ad_account_id)
...
#         video_data[AdCreativeVideoData.Field.video_id] = video.get_id()
#         video_data[AdCreativeVideoData.Field.image_url] = created_thumbnail["url"]
#         video_data[AdCreativeVideoData.Field.message] = 'Primary text' #Primary text
#         video_data[AdCreativeVideoData.Field.link_description] = 'Description' #Description
#         video_data[AdCreativeVideoData.Field.title] = 'Headline' #Headline
